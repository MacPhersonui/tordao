...
const Home = ({
    ...
    const remaining = () => {
        if(period == 0){
            console.log(starttime.starttime2 * 1000 - new Date().getTime())
            return starttime.starttime2 * 1000 - new Date().getTime()
        }
        if (period == 1) {
            console.log(starttime.starttime4 * 1000 - new Date().getTime())
            return starttime.starttime4 * 1000 - new Date().getTime()
        }
        if (period == 2) {
            console.log(starttime.starttime6 * 1000 - new Date().getTime())
    ...
    const getProgress = () => {
        ...
        if (period == 0){
            if (IDO.IDO1 >= totalInvestment.totalInvestment1) {
                return totalInvestment.totalInvestment1 / IDO.IDO1
            }else{
                return 100
            }
        }
        if (period == 1) {
            if (IDO.IDO2 >= totalInvestment.totalInvestment2) {
                return totalInvestment.totalInvestment2 / IDO.IDO2
            } else {
                return 100
            }
        }
        if (period == 2) {
            if (IDO.IDO3 >= totalInvestment.totalInvestment3) {
                return totalInvestment.totalInvestment3 / IDO.IDO3
            } else {
                return 100
            }
        }
                    ...
                    <div className={styles.main}>
                        <div className={styles.ido}>
                                    ...
                                    <div className={styles.box_content}>
                                        <ul>
                                            <li>
                                                ...
                                                <p>
                                                    {
                                                        utils.formatEther(period == 0 ? IDO.IDO1 :
                                                            period == 1 ? IDO.IDO2 :
                                                                IDO.IDO3)
                                                    } <b>USDT</b></p>
                                            </li>
                            ...
                            <div className={styles.input}>
                                ...
                                <button onClick={()=>investmentTor()}>Investment</button>
