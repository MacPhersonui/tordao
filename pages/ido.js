                ...
                <nav className={styles.navbar}>
                    <div className={styles.menu_text_box}>
                        <div className={styles.left_text}>
                            ...
                            <a
                                href="/fusion2021/#block-arc">DOCS</a><a className="">COMMUNITY</a></div>
                        <div className={styles.right_text}>
                            <a className=""
                                href="/fusion2021/#block-stage">INFO</a><a className=""
                                    href="/fusion2021/#block-guests">IDO</a><a className=""
